...
* Scala: 3.3.0
* JDK: 17 or 19
* `llama.cpp`: The version suffix refers to the latest supported `llama.cpp` release (e.g. version `0.16.0-b8608` means that it supports the [b8608](https://github.com/ggml-org/llama.cpp/releases/tag/b8608) release). The newer releases are usually supported as well, provided there are no API changes.
